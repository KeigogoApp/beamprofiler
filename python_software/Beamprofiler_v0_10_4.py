...
class CV2:
    ...
    def beam_row_columns(img_data, ndata):  #ピークの行と列データ
...
class GUI:
    ...
    def button(frame):
        global pausebutton,axisbutton
        trackingphoto = tk.PhotoImage(file="tracking.png")
        #trackingphoto = trackingphoto.subsample(5)
        trackingbutton = ttk.Button(frame, image=trackingphoto, command=GUI.tracking_button, style="style.TButton")
