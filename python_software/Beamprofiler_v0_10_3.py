...
class GUI:
    def setup():
        ...
        global width, height, resize, resize_window
    ...
    def button(frame01):
        ...
        pausebutton = ttk.Button(frame01, image=pausephoto, command=GUI.pause_img, style="style.TButton")
        ...
        intensitybutton = ttk.Button(frame01, image=intensityphoto, command=GUI.intensity_button, style="style.TButton")
        intensitybutton.image = intensityphoto
        intensitybutton.grid(row=1, column=5)
        
        autocorrelatorphoto = tk.PhotoImage(file="autocorrelator.png")
        autocorrelatorphoto = autocorrelatorphoto.subsample(5)
        autocorrelatorbutton = ttk.Button(frame01, image=autocorrelatorphoto, command=GUI_menu.switch_state, style="style.TButton")
