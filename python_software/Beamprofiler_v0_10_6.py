...
class GUI_menu:
    ...
    def tab_savefile(t5):
        ...
        barbutton = ttk.Checkbutton(savefilelabel, text="Color bar", command=GUI_menu.get_var, variable=varbar, style="style.TCheckbutton")
        barbutton.grid(row=2, column=1, sticky="w", padx=20)
        
        intensitybutton = ttk.Checkbutton(savefilelabel, text="Intensity plot", command=GUI_menu.get_var, variable=varintensity, style="style.TCheckbutton")
