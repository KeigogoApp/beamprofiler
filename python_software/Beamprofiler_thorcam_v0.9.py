...
class GUI_menu:
    ...
    def tab_savefile(t5):
        ...
        imgbutton = ttk.Checkbutton(t5frame1, text="Color image", command=GUI_menu.get_var, variable=varimg, style="style.TCheckbutton")
        ...
        barbutton = ttk.Checkbutton(t5frame1, text="with color bar", command=GUI_menu.get_var, variable=varbar, style="style.TCheckbutton")
        barbutton.grid(row=2, column=2, sticky="w")
        
        intensitybutton = ttk.Checkbutton(t5frame1, text="with intensity plot", command=GUI_menu.get_var, variable=varintensity, style="style.TCheckbutton")
